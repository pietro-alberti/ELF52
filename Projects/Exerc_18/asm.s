...
main    MOV R0, #(PORTN_BIT)                              ; Atribui a R0 endereço da porta N
        ...
        BL HabilitaPorta                                  ; habilita a porta F
        ...
        LDR R0, =GPIO_PORTF_BASE                        ; Endereço de memoria base da porta F
        MOV R1, #000010001b                             ; bits a seram habilitados da porta F    
        BL HabilitaGPIO_saida                           ; habilita os bits 0 e 4 da porta F
        BL Digital_Escreve_low
...
loop:   
        ...
        CMP R2, #000000001b                             ; Caso PJ0 esteja pressionado adiciona um no contador
        IT EQ
          ADDEQ R3, R3, #1b
          
        CMP R2, #000000010b                             ; Caso PJ1 e se estiver pressionado subtrai um no contador
        IT EQ
          SUBEQ R3, R3, #1b
